...
/**
 * Script to create demo profiles and patients with correct relationships
 * Architecture: auth.users.id = profiles.id -> patients.user_id
 */
...
async function createDemoData() {
  console.log('🚀 Creating Demo Profiles and Patients...\n');
  ...
  try {
    ...
    if (tenantError || !tenant) {
      console.error('❌ Error getting default tenant:', tenantError?.message);
      return;
    }
