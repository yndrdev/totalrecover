...
async function populateForms() {
  ...
  try {
    ...
    // Define comprehensive form data matching the actual table structure
    const formsData = [
      {
        tenant_id: tenantId,
        ...
        fields: [
          ...
          },
          {
            ...
            label: 'Do you have heart disease or have you had a heart attack?',
            type: 'yes_no',
            required: true,
            section: 'Current Medical Conditions',
          ...
          },
          {
            ...
            label: 'Do you have any breathing problems or lung disease?',
            type: 'yes_no',
            required: true,
            section: 'Current Medical Conditions',
      ...
      },
      {
        ...
        fields: [
          ...
          {
            id: 'allergies_list',
            label: 'What medications are you allergic to and what happens?',
            type: 'textarea',
            required: false,
            section: 'Allergies and Reactions',
          ...
          },
          {
            ...
            label: 'Do you take any vitamins, supplements, or herbal products?',
            type: 'yes_no',
            required: true,
          ...
          {
            id: 'supplements_list',
            label: 'What supplements, vitamins, or herbal products do you take?',
            type: 'textarea',
            required: false,
            section: 'Supplements and Vitamins',
      ...
      },
      {
        ...
        fields: [
          {
            id: 'pain_level',
            label: 'On a scale of 0-10, what is your current pain level?',
            type: 'pain_scale',
            required: true,
          ...
          },
          {
            ...
            label: 'Are you taking your pain medication as prescribed?',
            type: 'yes_no',
            required: true,
            section: 'Pain Assessment',
          ...
          {
            id: 'mobility_walking',
            label: 'Can you walk without assistance?',
            type: 'yes_no',
            required: true,
          ...
          },
          {
            ...
            label: 'How far can you walk without stopping?',
            type: 'single_choice',
            required: true,
            section: 'Activity and Mobility',
        ...
        fields: [
          {
            ...
            label: 'How well can you perform your daily activities?',
            type: 'scale',
            required: true,
          ...
          },
          {
            ...
            label: 'Are you able to return to work activities?',
            type: 'single_choice',
            required: false,
            section: 'Functional Assessment',
          ...
          },
          {
            ...
            label: 'How often are you doing your prescribed exercises?',
            type: 'single_choice',
            required: true,
          ...
          {
            id: 'functional_mood',
            label: 'How would you describe your mood and emotional well-being?',
            type: 'scale',
            required: true,
