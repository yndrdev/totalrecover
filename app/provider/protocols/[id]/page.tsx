...
import { ArrowLeft, Edit, Copy, Archive, Users, Clock, Calendar } from 'lucide-react'
...
export default function ProtocolDetail() {
  ...
  const [protocol, setProtocol] = useState<Protocol>({
    ...
    description: 'Comprehensive recovery protocol for patients undergoing total knee replacement surgery. This protocol includes exercises, assessments, medication reminders, and educational content to ensure optimal recovery outcomes.',
    duration_days: 14,
    surgery_type: 'total_knee',
  ...
  const handleDuplicate = () => {
    // TODO: Implement protocol duplication
    console.log('Duplicating protocol:', protocolId)
  }

  const handleArchive = () => {
    // TODO: Implement protocol archiving
    console.log('Archiving protocol:', protocolId)
  }
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-[#002238]">{protocol.name}</h1>
          </div>
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-[#002238] capitalize">{protocol.surgery_type.replace('_', ' ')}</p>
                </div>
                <div>
